let movies = [
    ...
    },
    {
        ...
        imdbRating: 8.9,
        posterurl:
            "https://smedia2.intoday.in/indiatoday/images/stories/2013november/krrish-2_660_110813025142.jpg",
    },
    {
        id: 6,
        title: "Gol Maal",
...
if (localStorage.getItem("movies") !== null) {
    ...
    movies = alldata.filter((moives, index) => {
...
function displayMoviesCards(arr) {
    ...
    arr.forEach((movie, index) => {
        ...
        let images = document.createElement('image');
        ...
        content.classList.add('class_info');
        ...
        content_subtitle.classList.add('content_subtitle');
        ...
        rating.appendChild(rating_title);

        let stars = document.createElement('div');
        stars.classList.add('stars');


        let fivestars = document.createElement('div');
        fivestars.classList.add('fivestars');
        stars.appendChild(fivestars);


        // displaying the yellow stars
        ...
        fivestars.appendChild(yellowstars);


        let currentRate = document.createElement('div');
        currentRate.classList.add('Ratenow');
        currentRate.append('Rate Now');

        // rating logic of the stars
        ...
        for (let i = 0; i <= 4; i++) {
            ...
            star.classList.add('fas');
            star.classList.add('fa-star');
            whitestars.appendChild(star);
        }
        fivestars.appendChild(whitestars);

        fivestars.appendChild(h3);
        rating.appendChild(stars);
        rating.appendChild(currentRate);
        content_subtitle.appendChild(rating);


        let button = document.createElement('button');
        button.classList.add('button');
        button.innerText = 'Details';
        content_subtitle.appendChild(button);
...
function selectRate(event) {
    ...
    let starRating = event.target.getAttribute("data-num");
...
function confirmRating(event) {
    ...
    let rating = event.target.getAttribute("data-num");
    console.log(rating);
...
function clearup(event) {
    ...
    if (isSubmitting === false) {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            stars[i].style.color = "rgb(204, 207, 207)";
